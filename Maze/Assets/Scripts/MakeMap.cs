...
public class MakeMap : MapGridField
{
    /*ゲームオブジェクト（デバッグ用）*/
    ...
    protected override void Start()
    {
        ...
        // スタートエレメント生成
        startElements = new Elements(gridField.GetGridCoordinate(gridField.middle),eFourDirection.top,Section.eMapSections.O_Section);
